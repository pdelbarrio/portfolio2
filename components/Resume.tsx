  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-center items-center">
        <Link
          href="https://res.cloudinary.com/getoutbcn/image/upload/v1681313200/portfolio/PablodelBarrio_english2023_haeity.pdf"
          target="_blank"
        >
        ...
        <Link
          href="https://res.cloudinary.com/getoutbcn/image/upload/v1681313200/portfolio/PablodelBarrio_spanish2023_khjrgw.pdf"
          target="_blank"
        >
