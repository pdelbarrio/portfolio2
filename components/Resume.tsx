  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-center items-center">
        <Link
          href="https://res.cloudinary.com/getoutbcn/image/upload/v1687273911/portfolio/PablodelBarrio_english2023_ux53we.pdf"
          target="_blank"
        >
        ...
        <Link
          href="https://res.cloudinary.com/getoutbcn/image/upload/v1687273911/portfolio/PablodelBarrio_spanish2023_fnhgvh.pdf"
          target="_blank"
        >
