  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-center items-center">
        <Link
          href="https://res.cloudinary.com/getoutbcn/image/upload/v1685301380/portfolio/PablodelBarrio_english2023_aevkki.pdf"
          target="_blank"
        >
        ...
        <Link
          href="https://res.cloudinary.com/getoutbcn/image/upload/v1685301373/portfolio/PablodelBarrio_spanish2023_c6cwky.pdf"
          target="_blank"
        >
