  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-center items-center">
        <Link
          href="https://res.cloudinary.com/getoutbcn/image/upload/v1686759698/portfolio/PablodelBarrio_english2023_x7afxm.pdf"
          target="_blank"
        >
        ...
        <Link
          href="https://res.cloudinary.com/getoutbcn/image/upload/v1686759698/portfolio/PablodelBarrio_spanish2023_asuyez.pdf"
          target="_blank"
        >
