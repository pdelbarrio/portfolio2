  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        src={skill.logo}
        className="rounded-full bg-white border border-gray-500 object-cover w-20 h-20 md:w-24 md:h-24 xl:w-28 xl:h-28 filter group-hover:grayscale transitio duration-300 ease-in-out"
      />
