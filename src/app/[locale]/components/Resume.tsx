  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-center items-center">
        <Link
          href="https://res.cloudinary.com/getoutbcn/image/upload/v1693918175/portfolio/PablodelBarrio_english2023_cqx0wb.pdf"
          target="_blank"
        >
        ...
        <Link
          href="https://res.cloudinary.com/getoutbcn/image/upload/v1693918177/portfolio/PablodelBarrio_spanish2023_fgx1ah.pdf"
          target="_blank"
        >
