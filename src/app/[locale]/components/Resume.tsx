  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-center items-center">
        <Link
          href="https://res.cloudinary.com/getoutbcn/image/upload/v1728998350/PablodelBarrio_Octubre2024ENG_taoho1.pdf"
          target="_blank"
        >
        ...
        <Link
          href="https://res.cloudinary.com/getoutbcn/image/upload/v1728998312/PablodelBarrio_Octubre2024CAST_fte7ww.pdf"
          target="_blank"
        >
